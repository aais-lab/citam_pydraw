...
# decolater
# animation
def animation(isAnimated: bool) -> function:
    def _ani(func: function) -> function:
...
# event
def mouseMoved(func: function) -> function:
...
def mousePressed(func: function) -> function:
    def _reg(*args, **kwargs):
        def tmp():
...
def mouseReleased(func: function) -> function:
    def _reg(*args, **kwargs):
        def tmp():
            global _IS_MOUSE_PRESSED_BEFORE
...
def mouseDragged(func: function) -> function:
    def _reg(*args, **kwargs):
        def tmp():
            if mouse.isPressed:
                func(*args, **kwargs)
...
def keyPressed(func: function) -> function:
    def _reg(*args, **kwargs):
        def tmp():
...
def keyReleased(func: function) -> function:
    def _reg(*args, **kwargs):
        def tmp():
